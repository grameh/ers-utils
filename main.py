...
class Interface(object):
    ...
    def search_for_entity(self, uri):
        table = self._table(["Peer name"])
        # list_of_peers = self.ers.search_by_uri(uri)
        print table
...
if __name__ == '__main__':
    ...
    # interface.search_for_entity(TEST_ENTITY)
    # print "# Adding statements to %s" % TEST_ENTITY
    # interface.add_statement(TEST_ENTITY, "rdf:type", "foaf:Agent")
